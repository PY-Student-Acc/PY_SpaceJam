...
class MyApp(ShowBase):
    ...
    def SetupScene(self):
        ...
        self.Hero = spaceJamClasses.Spaceship(self.loader, "./Assets/Spaceships/PercyJacksonIsBetter/PercyJacksonIsBetter.x", self.render, "Hero", "./Assets/Spaceships/PercyJacksonIsBetter/spacejet_C.png", (0, 0, 0), 1.1, self.taskMgr, self.render, self.accept)
