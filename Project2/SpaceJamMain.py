...
class MyApp(ShowBase):
    ...
    def SetupScene(self):
        ...
        self.Player = spaceJamClasses.Spaceship(self.loader, "./Assets/SpaceStation1B/spaceStation.x", self.render, "Player", "./Assets/SpaceStation1B/SpaceStation1_Dif2.png", (0, 0, 0), 5)
        ...
        for j in range(fullCycle):
            ...
            self.DrawCircleX(self.Planet2, nickName, j)
